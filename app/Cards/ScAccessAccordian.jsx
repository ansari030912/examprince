  ...
  return (
    <div className="bg-gray-50 flex flex-col items-center justify-center relative overflow-hidden ">
      ...
      >
        ...
        <Divider />
        <DialogContent className="text-white bg-gradient-to-br from-gray-800 to-blue-400">
          <div
            id="default-carousel"
        ...
        <Divider />
        <DialogActions className="text-white bg-gradient-to-br from-gray-800 to-blue-400">
